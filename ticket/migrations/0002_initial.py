# Generated by Django 4.2.5 on 2025-08-29 23:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='authentication.userinstance')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_predefind', models.BooleanField(default=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('workflow', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='events', to='ticket.workflow')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='ticket',
            name='supportGroup',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='authentication.supportgroup'),
        ),
        migrations.AddField(
            model_name='ticket',
            name='supportLabels',
        ...
        migrations.AddField(
            model_name='ticket',
            name='supportTeam',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='authentication.supportteam'),
        ),
        migrations.AddField(
            model_name='ticket',
            name='type',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.supportteam')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.supportgroup')),
                ('savedReply', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ticket.savedreplies')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='groups',
            field=models.ManyToManyField(related_name='saved_replies_groups', through='ticket.SavedRepliesGroupsThrough', to='authentication.supportgroup'),
        ),
        migrations.AddField(
            model_name='savedreplies',
            name='teams',
            field=models.ManyToManyField(related_name='saved_replies_teams', through='ticket.SavedRepliesTeamsThrough', to='authentication.supportteam'),
        ),
        migrations.AddField(
            model_name='savedreplies',
            name='user',
        ...
        migrations.CreateModel(
            name='PreparedResponseSupportTeamsThrough',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('preparedResponse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ticket.preparedresponse')),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.supportteam')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='PreparedResponseSupportGroupsThrough',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.supportgroup')),
                ('preparedResponse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ticket.preparedresponse')),
